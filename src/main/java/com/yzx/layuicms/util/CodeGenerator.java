...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\Java_Learn\\layuicms\\src\\main\\java");
        gc.setAuthor("yzx");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/layuiCMS?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
...
//        pc.setModuleName("sys");
        pc.setParent("com.yzx");//controller entity  service  service.impl
